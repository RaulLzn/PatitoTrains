...
import patitotrains.controller.userManagementController.interfaces.EditUserControllerInterface;
    ...
    public void btnApplyClicked(ActionEvent event) throws NotBoundException, RemoteException {
        ...
        if(valuesFormatOk){
            ...
            if(toEdit){
                ...
                User userEdited = new User(name, lastName, nmrs, isDisabled, id, userName, password);
                ...
                if(userManager.editUser(user, userEdited)){
                    ...
                    log.logAction("Editado el usuario: " + userName + ".");
                    setValues();
                    noEditMode();
                }else{
