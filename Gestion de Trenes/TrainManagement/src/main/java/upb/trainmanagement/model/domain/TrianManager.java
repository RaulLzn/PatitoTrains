...
public class TrianManager {
    
    LinkedList<Train> trainList;
    LinkedList<TrainType> trainTypes;
    ...
    public LinkedList<Train> searchTrainsByString(String trainToSearch){
    ...
    public static Train[] trainArray(LinkedList<Train> list){
    ...
    public String toString() {
        return "TrianManager [trainList=" + trainList.toString() + "]";
    }
