...
public class RegisterTrainController implements Initializable{
    ...
    public RegisterTrainController(){
        ...
        trainIdCounter = 10028; // Temporal, el contador de ID sera bajado de la base de datos, esto es usado para las pruebas,
    ...
    public RegisterTrainController(@SuppressWarnings("exports") LinkedList<Train> list){
        ...
        trainIdCounter = 10001; // Temporal, el contador de ID sera bajado de la base de datos, esto es usado para las pruebas,
        // Hasta que se conecte el modulo a la base de datos
    ...
    void btnAddClicked(ActionEvent event) {
        ...
        if(valuesFormatOk){
            ...
            id = Integer.toString(trainIdCounter + 1);
            ...
            if(toAdd){
                ...
                if(trainManager.addTrain(id, name, type, amtPassengerWagons)){
                    ...
                    trainIdCounter = trainIdCounter + 1;
    ...
    public TrainType trainTypeSelected(){
