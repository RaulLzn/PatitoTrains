...
import upb.ticketpurchase.model.domain.ContactPerson;
...
import upb.ticketpurchase.view.RouteDataView;
...
public class PassengerDataController implements Initializable{
    ...
    public PassengerDataController(){
    ...
    void btnContinueClicked(ActionEvent event) throws IOException {
        ...
        if(valuesFormatOk){
            ...
            if(!txtFieldWeightOne.getText().isBlank()){
                weightOne = Double.parseDouble(txtFieldWeightOne.getText());
            }

            if(!txtFieldWeightTwo.getText().isBlank()){
                weightTwo = Double.parseDouble(txtFieldWeightTwo.getText());
            }
            ...
            if(toContinue){
                ...
                Array<Double> weight = new Array<>(2);
                if(weightOne != 0){
    ...
    private void continueNextPage(Event event, Passenger passenger, Array<Double> weights) throws IOException{
